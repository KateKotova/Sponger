...
1.1. Запустить Microsoft Excel.
1.2. Закрыть все открытые рабочие книги.
1.3. Выбрать пункты главного меню "Сервис\Макрос\Безопасность...".
1.4. В открывшемся диалоговом окне "Безопасность" перейти на вкладку "Уровень безопасности".
1.5. Установить низкую или среднюю (предпочтительнее) безопасность.
1.6. Подтвердить выбранный режим нажатием кнопки "ОК".
2. Открыть Sponger.
